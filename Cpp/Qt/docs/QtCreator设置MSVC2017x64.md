* 打开 `工具 - 选项 - 构建和运行 - 构建套件 (Kit)`，选中 MSVC2017，感叹号表示未配置好，没设置的原因是缺少 Windows 的调试器，这需要下载 [Win10SDK 下载器](https://developer.microsoft.com/en-US/windows/downloads/windows-10-sdk)
