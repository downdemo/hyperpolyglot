...
* 将此自定义控件用 setCellWidget 添加到 QTableWidget 会出现不能填满单元格的问题

![](../images/qcombobox2.png)

* 将 MyCBX 内部的 layout 设置边距之后可以改善，但仍然不能填满单元格

```cpp
layout->setContentsMargins(0, 0, 0, 0);
```

![](../images/qcombobox3.png)
