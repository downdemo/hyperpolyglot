...
* 下载并安装 [Go](https://studygolang.com/dl)

```sh
go_version=1.23.3
wget -c https://studygolang.com/dl/golang/go${go_version}.linux-amd64.tar.gz -O - | sudo tar -xz -C /usr/local
...
* 在桌面创建文件夹 `demo`，并执行 `go mod demo-project` 初始化名为 `demo-project` 的项目
